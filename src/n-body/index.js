...
import {initialize} from './demo.js';
import {interleavedStripRoundCapJoin3DDEMO} from './commands.js';
class Simulation {
  /**
   * @param {number} nMasses 
...
const interleavedStripRoundCapJoin3DDEMO_16 = interleavedStripRoundCapJoin3DDEMO(
  regl,
  16
);
...
function renderLoop() {
  ...
  for (let i = 0; i < sim.nMasses; i++) {
    ...
    interleavedStripRoundCapJoin3DDEMO_16({
